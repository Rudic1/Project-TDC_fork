...
namespace TDC.Backend.Test.DomainTests.AccountHandlerTests
{
    public class CancelFriendRequestTests
    {
        ...
        [Test]
        public void CancelFriendRequest_CallsDeleteFriendRequest() 
        {
            _target.CancelFriendRequest("test-user", "test-receiver");
            _friendRequestRepository.Received().DeleteFriendRequest("test-user", "test-receiver");
        }
    }
}
